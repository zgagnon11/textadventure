...
class Merchant(Entities):
    ...
    def reduce_player_money(self, user_input):
        player_money = self.money
        while self.money > 0:
            if "1" in user_input:
                player_money = player_money - self.inventory[0]["price"]
                print("Here is your: " + self.inventory[0]["item"])
            elif "2" in user_input:
                player_money = player_money - self.inventory[1]["price"]
                print("Here is your: " + self.inventory[1]["item"])
            elif "3" in user_input:
                player_money = player_money - self.inventory[2]["price"]
                print("Here is your: " + self.inventory[2]["item"])
            elif "4" in user_input:
                player_money = player_money - self.inventory[3]["price"]
